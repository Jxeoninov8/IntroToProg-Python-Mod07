...
#   Jeisson Guerrero Estrada, 02/28/2024
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def first_name(self, value: str):
        if value.isalpha() or value == "":
            ...
            raise ValueError("The First Name should not contain any numbers.")
...
class Student(Person):
    ...
    def course_name(self, value: str):
        if value.isalpha() or value == "":
            ...
            raise ValueError("The Course Name should not contain any numbers.")


    # TODO Override the __str__() method to return the Student data (Done)

    def __str__(self):
        return f"{super().__str__()}, {self.course_name},"  # using super() to get parent class string representation
